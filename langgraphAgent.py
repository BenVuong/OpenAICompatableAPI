...
@tool
def osTerminalCommandTool(command: str) -> str:
    """Use this tool to execute terminal commands to interact with the operating system
        Commands should standard linux commands like mkdir to make a directory or ls to see the contains of the current directory"""
    try:
...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            " If the user asks you to interact with the current linux operating system use the osTerminalCommandTool to exectute standard linux commands"
            " To get the current date and time, use the linux command date" 
